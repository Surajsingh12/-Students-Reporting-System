...
public class StudentData {
        public static void main(String[] args) {
                ...
                s11.get(1,"Sumit",19052,61,78, 91);
                s21.get(1,"Raju", 19053, 77,91,65);
                s31.get(1,"Priya", 19054, 85, 65,87);

                s12.get(2,"Sumt",19052,68,74, 96);
                s22.get(2,"Raju", 19053, 67,81,75);
                s32.get(2,"Priya", 19054, 75, 95,77);
